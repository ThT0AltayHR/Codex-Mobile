...
import com.codex.mobile.CodexApplication
import com.codex.mobile.MainActivity
import com.codex.mobile.R
            ...
            runtime.launch(args, extraEnv, conversationId).collect { event ->
                ...
                when (event) {
                    is CodexEvent.Exited -> {
                        ...
                        updateNotification(if (event.code == 0) "Codex görevi tamamlandı" else "Codex görevi hata ile bitti (${event.code})")
                    }
